/**
  ******************************************************************************
  * @file    stm32wlxx_radio_default_timings.h
...
#ifndef __STM32WLXX_RADIO_DEFAULT_TIMINGS_H_
#define __STM32WLXX_RADIO_DEFAULT_TIMINGS_H_
...
#define STM32WLxx_RADIO_CFG_USE_DEFAULT_TIMINGS          (0u)   /*!< Indicates that the rdio driver should apply default Tx/Rx processing timings (if available) for the current configuration */
 ...
 */
#  define STM32WLxx_LORA_TX_DEFAULT_PROCESS_DELAY_US     (1324u) /*!< Time difference (in useconds) between the moment when Sidewalk MAC schedules to send data and the first bit of radio Tx in air */
#  define STM32WLxx_LORA_RX_DEFAULT_PROCESS_DELAY_US     (759u)  /*!< Time difference (in useconds) between the moment when Sidewalk MAC starts Rx and the actual opening of the Rx window by the radio */

#  define STM32WLxx_FSK_TX_DEFAULT_PROCESS_DELAY_US      (3428u) /*!< Time difference (in useconds) between the moment when Sidewalk MAC schedules to send data and the first bit of radio Tx in air (must also cover Carrier Sense before actual Tx) */
#  define STM32WLxx_FSK_RX_DEFAULT_PROCESS_DELAY_US      (804u)  /*!< Time difference (in useconds) between the moment when Sidewalk MAC starts Rx and the actual opening of the Rx window by the radio */
...
#endif /* __STM32WLXX_RADIO_DEFAULT_TIMINGS_H_ */
