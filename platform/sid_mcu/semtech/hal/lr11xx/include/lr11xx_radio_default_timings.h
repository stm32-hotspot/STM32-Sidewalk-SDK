...
#define LR11XX_RADIO_CFG_USE_DEFAULT_TIMINGS          (0u)   /*!< Indicates that the rdio driver should apply default Tx/Rx processing timings (if available) for the current configuration */
 ...
 */
#  define LR11XX_LORA_TX_DEFAULT_PROCESS_DELAY_US     (905u) /*!< Time difference (in useconds) between the moment when Sidewalk MAC schedules to send data and the first bit of radio Tx in air */
#  define LR11XX_LORA_RX_DEFAULT_PROCESS_DELAY_US     (701u) /*!< Time difference (in useconds) between the moment when Sidewalk MAC starts Rx and the actual opening of the Rx window by the radio */
