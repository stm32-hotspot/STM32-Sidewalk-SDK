...
/**
 * @brief Sub-GHz radio maximum interrupt priority - use to capture radio event timestamps precisely
 */
#define RADIO_IRQ_PRIO_HIGH (0u)

/**
 * @brief Sub-GHz radio interrupt priority whenever realtime response is not required
 */
#define RADIO_IRQ_PRIO_LOW  (5u)
...
#else
#error "CRITICAL_SECTION_BEGIN is defined already"
...
#else
#error "CRITICAL_SECTION_END is defined already"
