...
#if !defined(STM32WBA5x) && (defined(STM32WBA50xx) || defined(STM32WBA52xx) || defined(STM32WBA54xx) || defined(STM32WBA55xx) || defined(STM32WBA5Mxx))
#define STM32WBA5x
#endif
...
/*^^^ END OF PATCH STMC-485 ^^^*/
  ...
  /*vvv PATCH STMC-485 vvvvvvvvvv*/
  // while(RNG->SR & (1 << 4));
  while(READ_BIT(RNG->SR, RNG_SR_BUSY) != 0u);
  /*^^^ END OF PATCH STMC-485 ^^^*/
 ...
 * It implements a simple state machine that enables the RNG,
