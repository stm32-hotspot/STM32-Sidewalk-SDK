...
class CloudFormationClient:
    ...
    # Deploy
    # -------
    def create_stack(self, stack_name: str, template_params: dict, tag: str, template: str = None, template_url: str = None, lambda_sources: dict=None):
        """
        ...
        if lambda_sources:
            for lambda_name, src in lambda_sources.items():
                parameters.append({
                    'ParameterKey': f'{lambda_name}LambdaSrc',
                    'ParameterValue': f'{src}.zip',
                })
